# coding: utf-8
# https://blog.csdn.net/kudos09/article/details/88422104
import xlrd
import xlwt
import os
import sys
...
def read(file, sheet_index=0):
    ...
    try:
        for i in range(1, sheet1.nrows):
            if (sheet1.row_values(i)[21] != "" and '.' in sheet1.row_values(i)[21] and sheet1.row_values(i)[21] != '0.0.0.0'):  #判断“ip地址”列不为空
                count += 1
                for j in range(0, 22):
    ...
    sheet2 = workbook2.add_sheet(u'ip地址归属地合并',cell_overwrite_ok=True) #创建sheet
    # 将结果保存到新的excel文件中
